...
public class ServerParser1 {
    private List<String> servers = new CopyOnWriteArrayList<>();
    private int number = -1;
    
    public static void main(String... a) {
    	for (String ip : new ServerParser1().init().getServers()) {
    		System.out.println(ip);
    	}
    }

    public ServerParser1 init() {
    ...
    private void parseServers(boolean print) {
        ...
        try {
            ...
            Document document = Jsoup.connect("https://monitoringminecraft.ru/novie-servera").get();
        ...
        try {
            ...
            Document document = Jsoup.connect("https://minecraftrating.ru/new-servers/").get();
        ...
        try {
            ...
            Document document = Jsoup.connect("https://tmonitoring.com/").get();
        ...
        try {
            ...
            Document document = Jsoup.connect("https://minecraft-statistic.net/ru/").get();
