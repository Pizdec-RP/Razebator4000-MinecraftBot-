...
public class Pig implements Tickable {
	private Vector3D beforepos;
	public Entity en;
	public AABB collider;
	public ItemStack item;
	private dataSend d = dataSend.velandpos;
	private boolean velsended = false;
	
	public Pig(Vector3D pos, Vector3D vel) {
		this.beforepos = pos;
		collider = new AABB(0.45,0.45,0,-0.9,-0.45,-0.45);
		this.en = new Entity(Server.nextEID(),UUID.randomUUID(),EntityType.PIG, pos, 0f,0f);
		en.vel = vel;
		BotU.log("eid: "+en.eid);
	}
